      ...
      <div className="home howto">
            ...
            <div className="main">
              <div className="side center">
                <div className="visDisplay" >
                  ...
                  <div className="hint" key="hints"><span className="title">Hint:</span>
                    &nbsp;It's a type of&nbsp;
                    <span id="hintContent" key="hintcontent" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                  </div>
                  <div className="selected-vis" key="visDisplay">
                    <div>
                      <div className="visWrapper" key={'viswrapper0'}>
                        <img src={vis[0]} alt={'vis0'} key={'vis0'} />
                      </div>
                      <div className="visWrapper" key={'viswrapper1'}>
                        <img src={vis[1]} alt={'vis1'} key={'vis1'} />
                      </div>
                    </div>
                    <div>
                      <div className="visWrapper" key={'viswrapper2'}>
                        <img src={vis[2]} alt={'vis2'} key={'vis2'} />
                      </div>
                      <div className="visWrapper" key={'viswrapper3'}>
                        <img src={vis[3]} alt={'vis3'} key={'vis3'} />
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div className="side right">
            ...
            <div className="expla">
              ...
              <div className="btnWrap">
                <div className="btn outline" onClick ={() => {
        ...
        <div className="howToWrapper">
          ...
          <div className="howto">
            ...
            <div className="title">
              Step 3.<br />
              Make other players guess or guess the original image.
            </div>
            <div className="expla">
              Take turns and make other players guess or guess what other people’s original image is.
            </div>
          </div>
        </div>
      </div>
